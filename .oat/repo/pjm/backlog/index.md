...
- **Mobile theme (2026-07-03):** six items were spawned as deferred-but-wanted follow-ups from the `mobile-mvp` project's brainstorm/discovery/design — `BL-260703-adopt-eas-update-for-ota`, `BL-260703-universal-links-for-game`, `BL-260703-maestro-e2e-regression-suite`, `BL-260703-android-support-for-the-mobile`, `BL-260703-re-evaluate-xcode-27-mcp`, and `BL-260703-adopt-sentry-crash-reporting` (Sentry only — no Crashlytics, which would drag in the unused Firebase SDK). All sequence after mobile-mvp ships; Maestro and EAS Update are the natural first iterate-phase picks, and the Xcode 27 item has a real-world trigger (~Sept 2026 GA).

<!-- OAT BACKLOG-INDEX -->
| ID | Title | Status | Priority | Scope | Estimate |
| --- | --- | --- | --- | --- | --- |
| BL-260703-adopt-eas-update-for-ota | Adopt EAS Update for OTA delivery | open | medium | feature | M |
| BL-260703-adopt-sentry-crash-reporting | Adopt Sentry crash reporting for mobile | open | medium | task | S |
